...
class AccessToken {
  ...
  /// @nodoc
  static const String AS_FORMENCODED_BODY_PARAMETER = "asFormEncodedBodyParameter";
  /// @nodoc
  static const String AS_AUTHORIZATION_REQUEST_HEADER = "asAuthorizationRequestHeader";
  ...
  AccessToken({@required Map accessToken}){
    ...
    this._asFormEncodedBodyParameter = accessToken[AS_FORMENCODED_BODY_PARAMETER];
    this._asAuthorizationRequestHeader = accessToken[AS_AUTHORIZATION_REQUEST_HEADER];
  }
  ...
  static Map getAccessTokenMap({@required AccessToken accessToken}){
    ...
    tokenMap[AS_FORMENCODED_BODY_PARAMETER] = accessToken._asFormEncodedBodyParameter;
    tokenMap[AS_AUTHORIZATION_REQUEST_HEADER] = accessToken._asAuthorizationRequestHeader;
    return tokenMap;
  }
